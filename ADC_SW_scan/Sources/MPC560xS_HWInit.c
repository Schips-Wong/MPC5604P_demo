...
/*
 *
 * FILE : MPC560xS_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC560xS derivative needed initializations, 
 *  and all initializations for the MPC560xS boards which are supported.
...
#include "MPC560xS.h"        /* MPC55xx platform development header            */
#include "MPC560xS_HWInit.h"
...
/*******************************************************/
/* MPC560xS derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC560xS. 
*/
...
nofralloc
    ...
    /* MPC560xS SRAM initialization code                                 */
...
/*******************************************************/
/* MPC560xS boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC560xSDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC560xSDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC560xS external bus
        Set up the pins
