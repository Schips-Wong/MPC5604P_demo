 ...
 *
 * DESCRIPTION:
 *  This file contains all MPC560xP derivative needed initializations, 
 *  and all initializations for the MPC560xP boards which are supported.
...
#include "MPC560xP.h"        /* MPC55xx platform development header            */
#include "MPC560xP_HWInit.h"
...
/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC560xP. 
*/
...
nofralloc
    ...
    /* MPC560xP SRAM initialization code                                 */
...
#if INIT_USED_BOARD==MPC560xPDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC560xPDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC560xP external bus
        Set up the pins
