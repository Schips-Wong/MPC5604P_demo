 ...
 */
// Aug 2009 SM- commented out Exceptions & INTC Interrupts; renamed .__bam_bootarea to .boot.
//               and shifted left bam_rchw 16 bits
...
//const unsigned long bam_rchw = (RCHW_VALUE);
const unsigned long bam_rchw = (RCHW_VALUE)<<16; // Shifted left 16 bits
