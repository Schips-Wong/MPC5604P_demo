...
# NOTE: for Diab, use 2 of the next 4 lines
...
# e_lis   r3, INTC_EOIR_PRC0@h	# MPC551x Dual Core/CW v2.3: Load upper half of proc'r 0 EIOR addr to r3
  e_lis   r3, INTC_EOIR@h       # Single Core/CW v2.3: Load upper half of EIOR address to r3
# e_lis   r3, INTC_EOIR_PRC0@ha	# MPC551x Dual Core/Diab: Load upper half of proc'r 0 EIOR addr. to r3
# e_lis   r3, INTC_EOIR@ha      # Single Core/Diab: Load upper half of EIOR address to r3
...
# e_or2i  r3, INTC_EOIR_PRC0@l     # MPC551x Dual Core/CW v2.3
# se_stw  r4, 0x0(r3)              # MPC551x Dual Core/CW v2.3 - Write 0 to proc'r 0 INTC_EOIR 
  e_or2i  r3, INTC_EOIR@l          # Single Core/CW v2.3
  se_stw  r4, 0x0(r3)              # Single Core/CW v2.3 - Write 0 to proc'r 0 INTC_EOIR
# e_stw   r4, INTC_EIOR_PRC0@l(r3) # MPC551x Dual Core/Diab - Write 0 to proc'r 0 INTC_EIOR 
# e_stw   r4, INTC_EIOR@l(r3)      # Single Core/Diab - Write 0 to proc'r 0 INTC_EIOR 
